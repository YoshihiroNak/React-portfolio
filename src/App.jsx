...
function App() {
  ...
  return (
    <>
      ...
      <section className='text-gray-700 border-t border-gray-200' id="about">
        <div className='container px-5 py-5 mx-auto'>
          <div className='text-center mb-20'>
            ...
            <p className='pb-10'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Illum, maiores voluptates! Necessitatibus praesentium ea aut rerum!
              Consectetur inventore voluptates illo
            </p>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Possimus harum ipsam necessitatibus similique ex saepe maiores itaque odit recusandae.
              Obcaecati quam at officiis sapiente alias tempore fugit, voluptatem id inventore quas. Odit fuga cum impedit neque similique porro dolore quos
              iure minus illo magnam ut nostrum, adipisci nemo. Sapiente aperiam cum repellendus nemo ullam mollitia architecto minima eaque magni! Deleniti
              et suscipit molestias. Enim facere temporibus quibusdam? Quasi asperiores exercitationem quaerat at tenetur laboriosam. Debitis impedit nulla
              officia iusto, maiores aut, itaque cum repellat ipsum ad distinctio porro reprehenderit! Sit earum dicta voluptatem. Fuga quo tempore dignissimos excepturi hic facilis.
            </p>
          </div>
          {/* div of card */}
          <div className='flex flex-wrap'>
            <div className='md:w-1/3 p-4'>
              <div className='bg-gray-200 rounded-lg p-8'>
                ...
                <div>
                  ...
                  <a href="https://moviemaestro.netlify.app" className='flex mt-3 text-green-500 items-center'>See more
            ...
            <div className='md:w-1/3 p-4'>
              <div className='bg-gray-200 rounded-lg p-8'>
                ...
                <div>
                  ...
                  <a href="https://github.com/YoshihiroNak/T2A2-API-Webserver-Project" className='flex mt-3 text-green-500 items-center'>See more
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#7ed321" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                      <path d="M5 12h13M12 5l7 7-7 7" />
                    </svg>
                  </a>
            ...
            <div className='md:w-1/3 p-4'>
              <div className='bg-gray-200 rounded-lg p-8'>
                ...
                <div>
                  <p>
                    Lorem ipsum dolor sit, amet consectetur adipisicing elit. Doloribus est, obcaecati corrupti nobis repellat unde laudantium ea eveniet odio minus?
                  </p>
                  <a href="https://website-portfolio-lovat.vercel.app/" className='flex mt-3 text-green-500 items-center'>See more
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#7ed321" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                      <path d="M5 12h13M12 5l7 7-7 7" />
                    </svg>
                  </a>
      ...
      <footer className='container py-4 px-3 mx-auto flex justify-center border-t border-gray-200'>
        <div className='text-gray-700'>&copy; 2024 Yoshihiro Nakagawasai</div>
      </footer>
    </>
  )
}
